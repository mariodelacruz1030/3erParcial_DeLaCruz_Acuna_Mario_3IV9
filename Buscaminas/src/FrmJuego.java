    ...
    private void crearTableroBuscaminas(){
        ...
        tableroBuscaminas.setEventoPartidaPerdida(new Consumer<List<Casilla>>() {
            ...
            public void accept(List<Casilla> t) {
                ...
                JOptionPane.showMessageDialog(null, "JUEGO PERDIDO", "PERDISTE", JOptionPane.WARNING_MESSAGE);
                juegoNuevo();
            }
        });
        tableroBuscaminas.setEventoPartidaGanada(new Consumer<List<Casilla>>() {
            ...
            public void accept(List<Casilla> t) {
                ...
                JOptionPane.showMessageDialog(null, "JUEGO GANADO", "GANASTE", JOptionPane.INFORMATION_MESSAGE);
                juegoNuevo();
            }
        });
